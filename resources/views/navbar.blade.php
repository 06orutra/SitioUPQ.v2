...
<head>
    ...
    <title>Main</title>
    <!-- Include via CDN Flowbite CSS -->
    <link rel="stylesheet" href="https://unpkg.com/flowbite@1.5.4/dist/flowbite.min.css" />
    <!-- Include via CDN Tailwind -->
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Include via CDN Flowbite JS -->
    <script src="https://unpkg.com/flowbite@1.5.4/dist/flowbite.js"></script>
</head>
<body>
    
    <!-- Nav Inicio bg-[#151930]-->     
    <nav class="bg-[#151930] px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 sticky">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="https://flowbite.com/" class="flex items-center">
                <img src="{{asset('img/svg/upq_logo_white.svg')}}" class="w-12 md:w-14 lg:w-22" alt="UPQ Logo"/>
            </a>
            <div class="flex md:order-2">
                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2.5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><img src="{{asset('img/svg/sii_logo.svg')}}" class="w-4 md:w-4 lg:w-5" alt="SII Logo" /></button>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-[#151930] sm:bg-[#151930] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">Dropdown <svg class="w-4 h-4 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></button>
                    <!-- Dropdown menu -->
    ...
    <nav class="bg-gray-50 dark:bg-gray-700">
        <div class="max-w-screen-xl px-1 py-1 mx-auto md:px-6">
            <div class="flex flex-row-reverse items-center">
                <ul class="flex flex-row mt-0 mr-6 space-x-4 text-sm font-medium">
                    <li>
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-1 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><img src="{{asset('img/svg/sii_logo.svg')}}" class="w-4 md:w-4 lg:w-5" alt="SII Logo" /></button>
                    </li>
                    <li>
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-1 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><img src="{{asset('img/svg/sii_logo.svg')}}" class="w-4 md:w-4 lg:w-5" alt="SII Logo" /></button>
                    </li>
    ...
    <!-- Footer Inicio -->
    <footer class="bg-[#151930] dark:bg-gray-900">
        ...
        <div class="bg-[#151930] py-6 px-4 dark:bg-gray-700 md:flex md:items-center md:justify-between">
    ...
    <!-- Contenido Modal SII Inicio -->    
    
    <!-- Contenido Modal SII Fin -->
